...
#define DELTA_DIAGONAL_ROD 100.0 // mm
...
// Mendel Parts V9 on 12V
    #define  DEFAULT_Kp 12.43//30//63.0
    #define  DEFAULT_Ki 0.38//2.25
    #define  DEFAULT_Kd 101.81//440
#endif // PIDTEM//P
...
const bool Z_MIN_ENDSTOP_INVERTING = false;//false;//true; // set to true to invert the logic of the endstop.
...
#define Y_MAX_POS 90
#define Y_MIN_POS -90
#define Z_MAX_POS 200//MANUAL_Z_HOME_POS
#define Z_MIN_POS 0
...
#define HOMING_FEEDRATE {150*60, 150*60, 2*60, 0}  // set the homing speeds (mm/min)

// default settings
// delta speeds must be the same on xyz
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,100,6400,95}//6047.24,95}//{80, 80, 80, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {200, 200, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {900,900,2,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_ZJERK                 0//5.0    // (mm/sec) Must be same as XY for delta
